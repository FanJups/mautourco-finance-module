...
public class TableViewDao {
	...
	public List<ReservationClaim> getData(LocalDate dateFrom, LocalDate dateTo, int idAgency, String serviceFilter,
		...
		try {
			...
			statement = con.prepareStatement(queryAll);
	...
	public void insertIntoSico(SicoInt s) throws SQLException {
		...
		try {
			...
			con = daoFactory.getConnection();
			preparedStatement = initializePreparedStatement(con, SQL_INSERT_SICO_INT, true, s.getMyDate(),
	...
	public void insertIntoSintercl(Sintercl s) throws SQLException {
		...
		try {
			...
			con = daoFactory.getConnection();
			preparedStatement = initializePreparedStatement(con, SQL_INSERT_SINTERCL, true, s.getSource(),
			...
			if (autoGeneratedValues.next()) {
				...
				System.err.println("Inserting into sintercl success");
			} else {
	...
	public void insertIntoSintercl2(Sintercl s) throws SQLException {
		...
		try {
			...
			con = daoFactory.getConnection();
			preparedStatement = initializePreparedStatement(con, SQL_INSERT_SINTERCL2, true, s.getSource(),
			...
			if (autoGeneratedValues.next()) {
				...
				System.err.println("2- Inserting into sintercl success");
			} else {
				System.err.println("2- Inserting into sintercl failed, no auto-generated value");
	...
	public void insertIntoSintercl3(Sintercl s) throws SQLException {
		...
		try {
			...
			con = daoFactory.getConnection();
			preparedStatement = initializePreparedStatement(con, SQL_INSERT_SINTERCL3, true, s.getSource(),
			...
			if (autoGeneratedValues.next()) {
				...
				System.err.println("3- Inserting into sintercl success");
			} else {
				System.err.println("3- Inserting into sintercl failed, no auto-generated value");
